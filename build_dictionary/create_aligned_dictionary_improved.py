...
def main():
    ...
    parser.add_argument("--tr-file", default="preprocessed_data/awesome_align_llm_dict_2k_lemma_transcription.txt",
                        help="Path to the Turkish text file")
    parser.add_argument("--en-file", default="preprocessed_data/awesome_align_llm_dict_2k_lemma_translation.txt",
                        help="Path to the English text file")
    parser.add_argument("--alignment-file", default="alignments_llm_dict_2k_lemma_output.txt",
                        help="Path to the alignment file")      
    parser.add_argument("--output-file", default="tr_en_dictionary_awesome_align_llm_dict_2k_lemma.txt",
                        help="Path to the output dictionary file")
    parser.add_argument("--min-freq", type=int, default=1, 
                        help="Minimum frequency for an alignment to be considered")
    parser.add_argument("--max-translations", type=int, default=1,
